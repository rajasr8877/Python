...
func_app = func.WsgiFunctionApp(app=app.wsgi_app, 
                           http_auth_level=func.AuthLevel.ANONYMOUS)

# func_app = func.FunctionApp(http_auth_level=func.AuthLevel.ANONYMOUS, methods=["get", "post", "put", "delete"], route="{*route}")

# @func_app.route(route="{*route}")
# def http_trigger_procedure_app(req: func.HttpRequest,context: func.Context) -> func.HttpResponse:
